...
Route::post('/mail-store', 'Frontend\PortfolioHomeController@store')->name('store');
...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::post('banners/update/{id}', 'Backend\PortfolioController@updateBanner')->name('admin.banners.updateBanner');
